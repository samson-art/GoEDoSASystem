 ...
 */
public class UserDAO extends AbstractJDBCDAO<User> implements ru.mephi.goedosa.DAO.interfaces.UserDAO {
    ...
    public List<User> parseResultSet(ResultSet rs) throws PersistException {
        ...
        try {
            while (rs.next()) {
                ...
                user.setAccess_level(parseAccessLevel(rs));
                list.add(user);
            }
        } catch (Exception e) {
    ...
    private Map<String, Integer> parseAccessLevel(ResultSet rs) throws SQLException {
        Map<String, Integer> access_level = new HashMap<String, Integer>();
        access_level.put("read", rs.getInt("access_level_read"));
        access_level.put("create", rs.getInt("access_level_create"));
        access_level.put("update", rs.getInt("access_level_update"));
        access_level.put("delete", rs.getInt("access_level_delete"));
        return access_level;
    }
